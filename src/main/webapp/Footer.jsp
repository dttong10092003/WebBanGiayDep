	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-3 col-lg-3 col-xl-3">
				...
				<hr class="bg-white mb-2 mt-0 d-inline-block mx-auto w-25">
				<ul class="list-unstyled">
					<li><i class="fa fa-home mr-2"></i>134 Lê Văn Việt, Q9, TPHCM</li>
					<li><i class="fa fa-envelope mr-2"></i>torch@gmail.com</li>
					<li><i class="fa fa-phone mr-2"></i>0366459144</li>
					<li><i class="fa fa-print mr-2"></i>0366459144</li>
				</ul>
			</div>
